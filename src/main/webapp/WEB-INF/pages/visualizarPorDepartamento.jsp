...
<body>
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">Relatório por Departamento</h1>
				</div>
			</div>
				...
				<div class="col-lg-12">
					<div class="panel panel-green">
						...
						<div class="panel-body">
							<form:form
								action="${pageContext.request.contextPath}/relatorio/departamento/envio"
								commandname="departamento" modelAttribute="departamento">
								<label>Nome do departamento</label>
								<div class="form-group input-group">
									<form:select path="nomeDepartamento">
										<c:forEach var="departamento" items="${departamentos}">
											<option class="form-control"
												placeholder="Digite o nome de uma categoria para busca"
												name="nome"><span class="input-group-btn"
													value="${departamento.nomeDepartamento}">${departamento.nomeDepartamento}</option>
										</c:forEach>
									</form:select>
										...
										<c:forEach var="item" items="${itens}">
											<div class="alert alert-info fade in">
												<a href="#" class="close" data-dismiss="alert"
													aria-label="close">&times;</a> <strong>Departamento:
												${item.departamento.nomeDepartamento}</strong><br><br> Codigo do
												item: ${item.codigo}<br> Codigo do produto:
												${item.produto.codigo}<br>
												Nome do produto: ${item.produto.nomeProduto}<br>
												 Fabricante:
												...
												${item.unidade.nomeUnidade }<br>  Quantidade de
