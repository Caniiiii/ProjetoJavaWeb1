...
<div class="form-group input-group">
                                            <input type="text" class="form-control" placeholder="Digite um Unidade para busca">
                                            <span class="input-group-btn" >
                                                <button class="btn btn-default" type="button"><i class="fa fa-search" ></i>
													...
													<form role="form">
														<div class="form-group">
															<label>Listar Unidades cadastrados</label> <select class="form-control">
		...
		<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">Cadastrar novo Unidade</div>
							<div class="panel-body">
								<div class="row">
								<div class="col-md-12">
									...
									<form role="form">
												...
												<div class="form-group">
													<label>Site</label> <input class="form-control"
														placeholder="Digite o site do Unidade" type="text">
												</div>
												<div class="form-group">
