            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li><a href="#"><i class="fa fa-user-md fa-fw"></i>Manutenção de usuários</a>
                       <li class="divider"></li>
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="#"><i class="fa fa-search  fa-fw"></i>Eletrônicos</a>
                                </li>
                                <li>
                                    <a href="#">Móveis</a>
                                </li>
...
<div class="form-group input-group">
                                            <input type="text" class="form-control" placeholder="Digite um Departamento para busca">
                                            <span class="input-group-btn" >
                                                <button class="btn btn-default" type="button"><i class="fa fa-search" ></i>
													...
													<form role="form">
														<div class="form-group">
															<label>Listar Departamentos cadastrados</label> <select class="form-control">
						...
						<div class="panel-heading">Cadastrar novo Departamento</div>
							<div class="panel-body">
								...
								<div class="col-md-12">
									...
									<form role="form">
												<div class="form-group">
													<label>Nome do Departamento</label> <input class="form-control"
														placeholder="Digite o nome do Departamento" type="text">
												</div>
												<div class="form-group">
													<label>Endereço</label> <input class="form-control"
														placeholder="Digite o endereço do Departamento" type="text">
												</div>
												
												<div class="form-group">
													<label>Telefone</label> <input class="form-control"
														placeholder="Digite o telefone do Departamento" type="number">
												</div>
												<div class="form-group">
													<label>Site</label> <input class="form-control"
														placeholder="Digite o site do Departamento" type="text">
												</div>
												<div class="form-group">
